  ...
  return (
    <div>
      <div className="my-6 mx-6 pb-2 min-w-screen">
        <div className="max-w-xl rounded overflow-hidden shadow-lg cursor-pointer bg-white my-4" onClick={() => expandActivity(activity.id)} data-bs-toggle="modal" data-bs-target="#exampleModalCenterr">
